...
Scratch permite compartir proyectos que ejecutan código de programación en un lenguaje muy sencillo que se escribe a base de conectar piezas de puzle. Aqui puedes encontrar este proyecto en scratch: https://scratch.mit.edu/projects/920589853/
...
crecimiento(N0 = 30, r = 0, tiempo = 10) #En 10 años pasamos de 30 a >1000 individuos.
crecimiento(N0 = 30, r = 0.1, tiempo = 10) #En 10 años pasamos de 30 a >1000 individuos.
crecimiento(N0 = 30, r = -0.1, tiempo = 10) #En 10 años pasamos de 30 a >1000 individuos.
```
...
crecimiento(N1 = 30, r = 1, k = 300, tiempo = 20)
```
...
crecimiento()
#gana azul
crecimiento(N01 = 30, r1 = 0.5, a11 = -0.005, a12 = -0.0035,
            N02 = 60, r2 = 0.5, a21 = -0.0035, a22 = -0.005, 
            tiempo = 20)
#gana roja
